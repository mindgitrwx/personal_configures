...
alias pysim='nvim ~/pyrobot/pyrobot/simulators/pysim.py'
alias engine='nvim ~/pyrobot/pyrobot/engine/__init__.py'
alias behavior='nvim ~/pyrobot/pyrobot/brain/behaviors/__init__.py'
alias tk='nvim ~/pyrobot/pyrobot/gui/TK.py'
alias Tk='nvim ~/pyrobot/pyrobot/gui/TK.py'
alias gui='nvim ~/pyrobot/pyrobot/gui/__init__.py'
alias symbolic='nvim ~/pyrobot/pyrobot/robot/symbolic.py'
alias tree='nvim ~/pyrobot/pyrobot/gui/widgets/tree.py'
alias TKwidget='nvim ~/pyrobot/pyrobot/gui/widgets/TKwidgets/__init__.py'
alias psom='nvim ~/pyrobot/pyrobot/brain/psom/__init__.py'
alias conx='nvim ~/pyrobot/pyrobot/brain/conx.py'
